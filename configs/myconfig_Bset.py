...
data = dict(
    ...
    train=dict(
        type='CocoDataset',
        classes=('HolePairLeft', 'HolePairRight', 'ACHole'),
        ann_file='data/KTHBYJtrain/annotation.json',
        img_prefix='data/KTHBYJtrain/',
        pipeline=[
            dict(type='LoadImageFromFile'),
            dict(type='LoadAnnotations', with_bbox=True, with_mask=True),
            dict(type='Resize', img_scale=(1333, 800), keep_ratio=True),
        ...
        seg_prefix='data/KTHBYJtrain/'),
    val=dict(
        type='CocoDataset',
        classes=('HolePairLeft', 'HolePairRight', 'ACHole'),
        ann_file='data/BYJ/val/instances_val.json',
        img_prefix='data/BYJ/val/',
        pipeline=[
            dict(type='LoadImageFromFile'),
            dict(
                type='MultiScaleFlipAug',
    ...
    test=dict(
        type='CocoDataset',
        classes=('HolePairLeft', 'HolePairRight', 'ACHole'),
        ann_file='data/KTHtest/annotation.json',
        img_prefix='data/KTHtest/',
        pipeline=[
            dict(type='LoadImageFromFile'),
            dict(
                type='MultiScaleFlipAug',
...
optimizer_config = dict(grad_clip=dict(max_norm=300, norm_type=2))
lr_config = dict(
    policy='step',
    warmup='linear',
    warmup_iters=500,
...
log_level = 'INFO'
resume_from = None
#resume_from = "./work_dirs/trainBYJ/epoch_7.pth"
#load_from = None
load_from = 'checkpoints/best_Bset_original.pth'
...
work_dir = './work_dirs/trainKTHBYJ_preBYJ'
gpu_ids = range(0, 1)
